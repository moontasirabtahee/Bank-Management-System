...
<div class="card w-100 text-center shadowBlue">
  ...
  <tbody>
    <?php
      $i=0;
      $array = $con->query("select * from customer,branch,account where customer.branchID = branch.branchId AND customer.userID=account.userID and account.userID != '100000'");
      if ($array->num_rows > 0)
      {
    ...
    ?>
      <tr>
        ...
        <td>Rs.<?php echo $row['accBalance'] ?></td>
